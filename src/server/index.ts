...
void new Wall({ x: -955, y: -900, width: 1000, height: 100 })
void new Wall({ x: -550, y: -700, width: 400, height: 210 })
void new Wall({ x: -1300, y: -500, width: 100, height: 100 })
void new Wall({ x: -1100, y: -500, width: 2, height: 600 })
void new Wall({ x: -941, y: -400, width: 1, height: 800 })
void new Wall({ x: -845, y: -500, width: 100, height: 600 })
void new Wall({ x: -700, y: -500, width: 100, height: 100 })
void new Wall({ x: -555, y: -500, width: 100, height: 100 })
void new Wall({ x: -410, y: -500, width: 100, height: 100 })
...
export const refWall = new Wall({ x: 450, y: 700, width: 100, height: 800 })
