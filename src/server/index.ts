...
const stage = new Stage({
  spawnOnScore: false, spawnOnDestroy: false
  // town: false, country: false, greek: false, centerBot: true, spawnOnTimer: true, spawnOnDestroy: false, spawnOnScore: false, spawnOnTag: true, wildBricks: true, wildPuppets: false, debugFeatures: true, debugPlayerVision: true
})
const app = express()
